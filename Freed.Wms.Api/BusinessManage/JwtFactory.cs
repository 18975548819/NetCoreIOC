    ...
    public class JwtFactory: IJwtFactory
    {
        ...
        public async Task<string> GenerateEncodedToken(string userNo, ClaimsIdentity identity)
        {
            var claims = new List<Claim>
            {
                ...
                identity.FindFirst("groupType"),
                identity.FindFirst("wmsRepertory")
            };
        ...
        public ClaimsIdentity GenerateClaimsIdentity(LoginUser user)
        {
            ...
            claimsIdentity.AddClaim(new Claim("groupType", user.GroupType));
            claimsIdentity.AddClaim(new Claim("wmsRepertory", user.WmsRepertory));
