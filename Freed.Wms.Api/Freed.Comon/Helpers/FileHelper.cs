...
namespace Freed.Common.Helpers
{
    ...
    public class FileHelper
    {
        ...
        private static string _webRootPath = AppDomain.CurrentDomain.BaseDirectory;
        ...
        public static void CreateDir(string dir,bool IsWeb = true)
        {
            ...
            try
            {
                if (IsWeb)
                {
                    if (!Directory.Exists(webRootPath + "\\" + dir))
                        Directory.CreateDirectory(webRootPath + "\\" + dir);
                }
                else
                {
        ...
        public static void DeleteDir(string dir,bool IsWeb = true)
        {
            ...
            try
            {
                ...
                {
                    if (Directory.Exists(webRootPath + "\\" + dir))
                        Directory.Delete(webRootPath + "\\" + dir,true);
                }
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            StreamWriter sw = new StreamWriter(webRootPath + "\\" + dir, false, System.Text.Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        public static void MoveFile(string dir1, string dir2,bool IsWeb = true)
        {
            ...
            if(IsWeb)
            {
                if (File.Exists(webRootPath + "\\" + dir1))
                    File.Move(webRootPath + "\\" + dir1, webRootPath + "\\" + dir2);
            }
            else
            {
        ...
        public static void CopyFile(string dir1, string dir2,bool IsWeb =true)
        {
            ...
            if (IsWeb)
            {
                if (File.Exists(webRootPath + "\\" + dir1))
                {
                    File.Copy(webRootPath + "\\" + dir1, webRootPath + "\\" + dir2, true);
                }
            }
            else
            {
        ...
        public static string GetLocalPath()
        {
            ...
            str = str.Replace("/", "\\");
            if (string.IsNullOrEmpty(CurrAppPath))
                CurrAppPath = str;
            else
            {
